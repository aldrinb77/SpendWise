        ...
        <div className="flex items-center gap-4">
          ...
          <DropdownMenu>
            <DropdownMenuTrigger render={
              <Button aria-label="User menu" variant="ghost" className="relative h-12 w-12 rounded-full p-0 overflow-hidden hover:scale-105 active:scale-95 transition-all">
