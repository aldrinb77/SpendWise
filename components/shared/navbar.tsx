    ...
    <nav className="sticky top-0 z-50 w-full border-b border-white/10 bg-white/50 dark:bg-slate-950/50 backdrop-blur-2xl">
      <div className="container mx-auto flex h-16 items-center justify-between px-6">
        ...
        <div className="flex items-center gap-4">
          <Button variant="ghost" size="icon" aria-label="Notifications" className="relative h-10 w-10 rounded-full hover:bg-primary/5">
            <LucideBell className="h-5 w-5 text-muted-foreground group-hover:text-primary transition-colors" aria-hidden="true" />
            <span className="absolute top-2.5 right-2.5 flex h-2 w-2 rounded-full bg-rose-500 ring-2 ring-background shadow-pulse" />
          </Button>

          <DropdownMenu>
            <DropdownMenuTrigger render={
              <Button variant="ghost" aria-label="User menu" className="relative h-12 w-12 rounded-full p-0 overflow-hidden hover:scale-105 active:scale-95 transition-all">
