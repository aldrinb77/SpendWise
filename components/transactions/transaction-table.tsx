                    ...
                    <td className="px-8 py-6 text-right">
                       <div className="flex items-center justify-end gap-2">
                          <button 
                            ...
                            aria-label={`Edit ${t.description || "Vendor"} transaction`}
                            title={`Edit ${t.description || "Vendor"} transaction`}
                          ...
                          <button 
                            ...
                            aria-label={`Delete ${t.description || "Vendor"} transaction`}
                            title={`Delete ${t.description || "Vendor"} transaction`}
